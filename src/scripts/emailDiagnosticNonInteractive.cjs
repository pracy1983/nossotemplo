/**
 * Script de diagnóstico não interativo para o serviço de email
...
const main = async () => {
  ...
  // Usar o email e nome passados como argumentos ou valores padrão
  const email = process.argv[2] || 'nossotemplosp@gmail.com';
